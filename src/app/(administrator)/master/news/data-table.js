    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, columnId, filterValue) => {
            ...
            return (
                ...
                row.original.news_category?.name?.toLowerCase().includes(search) ||
                                ...
                                {table
                                    ...
                                    .map((column) => {
                                        return (
                                            ...
                                            >
                                                {column.id === "preview_thumbnail"
                                                    ? "Thumbnail"
                                                    : column.id === "title"
                                                        ? "Judul"
                                                        : column.id === "news_category"
                                                            ? "Kategori Berita"
                                                            : column.id === "excerpt"
                                                                ? "Kutipan"
                                                                : column.id === "status"
                                ...
                                <TableRow>
                                    <TableCell colSpan={columns.length} className="h-32 text-center">
                                        <div className="flex flex-col items-center justify-center space-y-2">
                                            <div className="text-muted-foreground">Tidak ada data berita ditemukan</div>
